...
const RestaurantLayout = props => {
    ...
    useEffect(() => {
        dispatch(fetchRestaurant({})).then(({payload}) => {
            if (payload.error) {
                router.push('/restaurant/login').then(() => {
                })
            }
        })
    }, [])
    ...
    return (
        <>
            <Head>
                <title>Food Jocky Restaurant Panel</title>
                ...
                <div className="main-wrapper">
                    <Header layout={layout} setLayout={setLayout}>
                        <HeaderDropDownMenu
                            ...
                            title={"Hi, " + restaurant.name}
                        >
                            <div className="dropdown-title">My Id #1</div>
                            <MyLink className="dropdown-item has-icon">
                                <i className="far fa-user"/> {restaurant.name}
                            </MyLink>
                    ...
                    <Navbar siteIcon="/assets/img/logo.gif" siteTitle="Food Jocky" siteTitleMini="F..j.."
                            layout={layout} setLayout={setLayout} href="/restaurant">
                        <NavLink href="/restaurant" iconClassName="fas fa-tachometer-alt" title="Dashboard"/>
                        ...
                        <NavLink href="/restaurant/foods" iconClassName="fa fa-shopping-cart" title="Foods"/>
                        ...
                        <NavLink href="/restaurant/orders" iconClassName="fas fa-cubes" title="Orders"/>
                        <NavLink href="/restaurant/reports" iconClassName="fas fa-print" title="Reports"/>
